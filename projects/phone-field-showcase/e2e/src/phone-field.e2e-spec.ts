...
describe('Phone Field', () => {
  ...
  function runTests() {
    ...
    it('should match previous phone field screenshot when touched', async (done) => {
      await element(
        by.css('#screenshot-phone-field .sky-form-control')
      ).click();
    ...
    it('should match previous phone field screenshot when dropdown is open', async (done) => {
      const countrySearchBtn = element(
        by.css(
      ...
      const inputElement = element(
        by.css('#screenshot-phone-field textarea.sky-form-control')
      );
    ...
    it('should match previous phone field screenshot with a default country', (done) => {
      expect('#screenshot-phone-field-default').toMatchBaselineScreenshot(
        done,
        {
    ...
    it('should match previous phone field screenshot with a default country (screen: xs)', async (done) => {
      await SkyHostBrowser.setWindowBreakpoint('xs');
    ...
    it('should match previous phone field screenshot inside input box', async (done) => {
      ...
      expect('#screenshot-phone-field-input-box').toMatchBaselineScreenshot(
        done,
        {
      ...
      expect('#screenshot-phone-field-input-box').toMatchBaselineScreenshot(
        done,
        {
          screenshotName: getScreenshotName(
            'phone-field-country-search-input-box'
          ),
        }
      );
    });
